...
- Standard `GET`, `SET`, and `BACKUP` requests are accepted only after the built-in connection-open special request is received.
...
class AppDataHandler : public DataHandler
{
    ...
    {
        // Forward the SysEx7/Data64 UMP packet to your MIDI transport.
        return true;
    }
};
...
/*
 * Feed real incoming SysEx7/Data64 UMP packets into the protocol after your
 * transport decodes them. Multi-packet SysEx7 messages are reassembled
 * internally, and standard GET/SET/BACKUP traffic requires a prior built-in
 * connection-open request from the remote side.
 */
const midi_ump packet = /* read one SysEx7/Data64 UMP from your MIDI transport */;
